...
const AdminOrder = ({rounded = false}) =>{
    ...
    return <div>
        <Navbar />
        <div>
            <div className="filter-span"><Link to="/ADmIn/medicineOrder"><span className="filter-span" style={{borderBottom:"2px white solid"}}>Deliverd</span></Link> 
            <Link to="/ADmIn/medicineOrder/NotDeliverdMed"><span>Not Deliverd</span></Link></div>
